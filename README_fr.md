...
> [!NOTE]
> Les blocs de prompt restent identiques dans toutes les langues. Les titres issus des sources peuvent garder leur formulation originale afin de préserver la limite du prompt.
