...
- API 文件: [`EvoLinkAI/Seedance-2.5-Gateway-Service`](https://github.com/EvoLinkAI/Seedance-2.5-Gateway-Service)
...
- 完整指南: [`EvoLinkAI/awesome-seedance-2.5-guide`](https://github.com/EvoLinkAI/awesome-seedance-2.5-guide)
...
2. 比較提示詞時，請看鏡頭邏輯、節奏、環境設計與一致性指令，而不只是主題。
3. 優先重用結構。在 Seedance 中，鏡頭推進與動作控制往往比替換名詞更重要。
4. 當 `@image1` 或 `<<<Image1>>>` 這類提示詞內 token 是預期語法的一部分時，請保留原樣。
5. 在這份清理後的資料集中，請把標題、分類與來源連結當作主要導航錨點。
