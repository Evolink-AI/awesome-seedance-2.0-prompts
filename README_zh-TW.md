...
**本儲存庫收錄 185 個具來源與作者標註的 Seedance 2.0 電影級影片生成提示詞案例。**
...
185 個不重複案例、8 個分類，並同步於 11 份 README。
...
- [📐 範本與結構化格式](#templates-structured) (18)
