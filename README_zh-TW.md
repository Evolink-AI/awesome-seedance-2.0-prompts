...
- API 文件: [`EvoLinkAI/Seedance-2.5-Gateway-Service`](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service)
- OpenClaw Skill: [`EvoLinkAI/seedance2-video-gen-skill-for-openclaw`](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service)
- 完整指南: [`EvoLinkAI/awesome-seedance-2.5-guide`](https://github.com/Evolink-AI/awesome-seedance-2.5-guide)
