...
[![Промпты-207 уникальных примеров](https://img.shields.io/badge/%D0%9F%D1%80%D0%BE%D0%BC%D0%BF%D1%82%D1%8B-207%20%D1%83%D0%BD%D0%B8%D0%BA%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D1%85%20%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D0%BE%D0%B2-111111)](README.md)
...
**Репозиторий содержит 207 уникальных промпта Seedance 2.0 с указанием источников для кинематографической генерации видео.**
...
203 уникальных примеров в 8 категориях, синхронизированных в 11 README-файлах.

<a id="how-to-use"></a>
## 🧭 Как пользоваться репозиторием

Выберите категорию, откройте пример с источником, скопируйте промпт и замените только нужный объект или медиассылки.
...
- [⚔️ Action / Fantasy](#action-fantasy) (44)
  ...
  - [Пример 44: Монтаж странника в постапокалипсисе (by @DjajaYerry75)](#action-fantasy-case-44)
- [🎞️ Cinematic Realism](#cinematic-realism) (11)
  ...
  - [Пример 11: Ралли-дрифт по грязному лесу (by @LudovicCreator)](#cinematic-realism-case-11)
- [🥽 POV / FPV](#pov-fpv) (21)
...
- [🏷️ Commercial / Product](#commercial-product) (29)
  ...
  - [Пример 28: Рекламный ролик курортного коврика для йоги (by @ou_zhen599)](#commercial-product-case-28)
  - [Пример 29: Героический ролик бутылки на йога-террасе (by @ou_zhen599)](#commercial-product-case-29)
- [🖼️ Reference-Driven](#reference-driven) (23)
  ...
  - [Пример 23: Взлёт дракона на горной вершине (by @minuitIA)](#reference-driven-case-23)
...
- [📐 Templates & Structured Formats](#templates-structured) (23)
  ...
  - [Пример 22: Chibi и штормовой взрыв окна (by @kinovi_ai)](#templates-structured-case-22)
  - [Пример 23: Влог из зала после тренировки (by @doctorwasif)](#templates-structured-case-23)
- [🎬 General Cinematic](#general-cinematic) (40)
  ...
  - [Пример 40: MiniDV-казус у тыквенной лавки (by @ou_zhen599)](#general-cinematic-case-40)
...
### Пример 2: [Поединок чёрного кота в пустыне](https://x.com/nopinduoduo/status/2039915824216261101) (автор [@nopinduoduo](https://x.com/nopinduoduo))
...
### Пример 5: [Ремонт в исполнении перепачканного смазкой механика](https://x.com/sebatheepan/status/2040079840754205010) (автор [@sebatheepan](https://x.com/sebatheepan))
...
### Пример 9: [Токусацу-битва гигантских ниндзя](https://x.com/EarthGigantea/status/2044026356984623194) (автор [@EarthGigantea](https://x.com/EarthGigantea))
...
### Пример 11: [Оригинальная 15-секундная короткометражка о битве стихий](https://web.archive.org/web/*/https://x.com/ZikinArt/status/2040006818953322644) (автор [@ZikinArt](https://x.com/ZikinArt))
...
### Пример 12: [Анимация фантазийного яйца в стиле Фаберже](https://x.com/ShamiWeb3/status/2040096061835059412) (автор [@ShamiWeb3](https://x.com/ShamiWeb3))
...
### Пример 15: [Непрерывная 15-секундная экшен-сцена одним кадром](https://x.com/Artedeingenio/status/2039997977897435190) (автор [@Artedeingenio](https://x.com/Artedeingenio))
...
### Пример 18: [Схватка за меха в невесомости](https://x.com/Dheepanratnam/status/2044338893764383111) (автор [@Dheepanratnam](https://x.com/Dheepanratnam))
...
### Пример 19: [Сверхскоростной полёт девушки верхом на драконе](https://x.com/naoyuki_okada/status/2039573038392614995) (автор [@naoyuki_okada](https://x.com/naoyuki_okada))
...
### Пример 20: [Оригинальная 15-секундная короткометражка о боевых искусствах в пустыне](https://x.com/NimEshed/status/2039816152222949829) (автор [@NimEshed](https://x.com/NimEshed))
...
### Пример 21: [Воздушный удар в каньоне](https://x.com/Mr_TuanDoan/status/2044750468849729604) (автор [@Mr_TuanDoan](https://x.com/Mr_TuanDoan))
...
### Пример 22: [Гиперреалистичный 15-секундный эпический военный блокбастер](https://x.com/john87445528/status/2039348028574744685) (автор [@john87445528](https://x.com/john87445528))
...
### Пример 24: [Непрерывная 15-секундная экшен-сцена одним кадром](https://x.com/Artedeingenio/status/2039333445403287777) (автор [@Artedeingenio](https://x.com/Artedeingenio))
...
### Пример 25: [Чёрный лебедь против боксёра](https://x.com/KanaWorks_AI/status/2045098229847716305) (автор [@KanaWorks_AI](https://x.com/KanaWorks_AI))
...
### Пример 26: [Взлёт Супермена сквозь треснувшую землю](https://x.com/techprophett/status/2045091209417249026) (автор [@techprophett](https://x.com/techprophett))
...
### Пример 27: [Тень меча в облачной пещере](https://x.com/Adam38363368936/status/2039865857179013318) (автор [@Adam38363368936](https://x.com/Adam38363368936))
...
### Пример 28: [Город богов — восточный фантазийный полёт одним кадром](https://x.com/john87445528/status/2041000256930763046) (автор [@john87445528](https://x.com/john87445528))
...
### Пример 29: [Эпическая фэнтезийная битва — кинематографическая сцена на 10 секунд](https://x.com/a_shimanski/status/2041431226507051027) (автор [@a_shimanski](https://x.com/a_shimanski))
...
### Пример 30: [Превращение в жанре тёмного фэнтези — восточный стиль](https://x.com/johnAGI168/status/2041146946681721113) (автор [@johnAGI168](https://x.com/johnAGI168))
...
### Пример 31: [Речная ловушка с крокодилом у топливопровода](https://x.com/rahulnanda86/status/2075816671080747410) (автор [@rahulnanda86](https://x.com/rahulnanda86))
...
### Пример 32: [Электрическая дуэль на подземной арене](https://x.com/CharaspowerAI/status/2075596085926514810) (автор [@CharaspowerAI](https://x.com/CharaspowerAI))
...
### Пример 33: [Крокодил тащит самолёт по взлётной полосе](https://x.com/rahulnanda86/status/2075816060360753484) (автор [@rahulnanda86](https://x.com/rahulnanda86))
...
### Пример 34: [Аниме-гол молниеносного нападающего](https://x.com/CharaspowerAI/status/2075583075044475292) (автор [@CharaspowerAI](https://x.com/CharaspowerAI))
...
### Пример 36: [Парфянский выстрел монгольской кавалерии](https://x.com/Ankit_patel211/status/2076945741898272939) (автор [@Ankit_patel211](https://x.com/Ankit_patel211))
...
Вариант модели: Seedance 2 Mini
...
### Пример 37: [Спринт курьера на гигантской лягушке](https://x.com/0xbisc/status/2077696618418377017) (автор [@0xbisc](https://x.com/0xbisc))
...
### Пример 39: [Буря в храме белого тигра](https://x.com/LudovicCreator/status/2078215686690590829) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 40: [Гигантская акула у продовольственной баржи](https://x.com/rahulnanda86/status/2077915652141285405) (автор [@rahulnanda86](https://x.com/rahulnanda86))
...
### Пример 41: [Сенсационная победа великанши на арене](https://x.com/rahulnanda86/status/2078861067896357244) (автор [@rahulnanda86](https://x.com/rahulnanda86))
...
### Пример 42: [Разгром нападающих телохранителем на складе](https://x.com/Rosey_watson/status/2078858021854130433) (автор [@Rosey_watson](https://x.com/Rosey_watson))
...
### Пример 44: [Монтаж странника в постапокалипсисе](https://x.com/DjajaYerry75/status/2079966353914769554) (автор [@DjajaYerry75](https://x.com/DjajaYerry75))
...
### Пример 3: [Воительница, пробуждённая метеором](https://x.com/ChrisTheNerv/status/2040043939109953944) (автор [@ChrisTheNerv](https://x.com/ChrisTheNerv))
...
### Пример 6: [Судья каннонбола у VHS-бассейна](https://x.com/Ankit_patel211/status/2077121431339725240) (автор [@Ankit_patel211](https://x.com/Ankit_patel211))
...
### Пример 11: [Ралли-дрифт по грязному лесу](https://x.com/LudovicCreator/status/2080005053461487791) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 1: [Погоня в камуфляже с нагрудной камерой](https://x.com/genel_ai/status/2039538309790404797) (автор [@genel_ai](https://x.com/genel_ai))
...
### Пример 2: [Динамичный ролик о киберпанковском Шанхае](https://x.com/Adam38363368936/status/2039498800801398911) (автор [@Adam38363368936](https://x.com/Adam38363368936))
...
### Пример 3: [Согласованный экшен-промпт о проклятом самурае](https://x.com/Just_sharon7/status/2040685931858907646) (автор [@Just_sharon7](https://x.com/Just_sharon7))
...
### Пример 20: [FPV-пролёт над фейерверками Франции](https://x.com/LudovicCreator/status/2077090789356609683) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 1: [Танцевальная сцена аниме-трио в стиле рекламы духов](https://x.com/ShadeLurk/status/2040671186984796632) (автор [@ShadeLurk](https://x.com/ShadeLurk))
...
### Пример 2: [Дуэль в церкви тёмного фэнтези](https://x.com/ZaraIrahh/status/2040667542390190245) (автор [@ZaraIrahh](https://x.com/ZaraIrahh))
...
### Пример 3: [Дуэль в зале святилища тёмного фэнтези](https://x.com/MiraMusic_AI/status/2040595365096034700) (автор [@MiraMusic_AI](https://x.com/MiraMusic_AI))
...
### Пример 4: [Неожиданная шутка в японской рекламе снеков](https://x.com/aigeboku/status/2040562471027782017) (автор [@aigeboku](https://x.com/aigeboku))
...
### Пример 5: [Кинематографическая сцена боевых искусств для Seedance 2](https://x.com/CharaspowerAI/status/2040376349504815467) (автор [@CharaspowerAI](https://x.com/CharaspowerAI))
...
### Пример 26: [Показ чемодана-такси в Мумбаи](https://x.com/rahulnanda86/status/2076874322145390605) (автор [@rahulnanda86](https://x.com/rahulnanda86))
...
### Пример 27: [Инфлюенсер-тур по вилле на утёсе](https://x.com/Ankit_patel211/status/2077762917198671925) (автор [@Ankit_patel211](https://x.com/Ankit_patel211))
...
### Пример 28: [Рекламный ролик курортного коврика для йоги](https://x.com/ou_zhen599/status/2080343369637839009) (автор [@ou_zhen599](https://x.com/ou_zhen599))
...
### Пример 29: [Героический ролик бутылки на йога-террасе](https://x.com/ou_zhen599/status/2079905616571818004) (автор [@ou_zhen599](https://x.com/ou_zhen599))
...
### Пример 1: [Выступление пианиста-скелета в миниатюрной диораме](https://x.com/tea_story_hoshi/status/2040614786933887043) (автор [@tea_story_hoshi](https://x.com/tea_story_hoshi))
...
### Пример 2: [Принцесса на корабле в шторме против кракена](https://x.com/applete77191758/status/2040450526819807277) (автор [@applete77191758](https://x.com/applete77191758))
...
### Пример 3: [Танец клинков служанок: Мэй против Коко](https://x.com/MiraMusic_AI/status/2040281710957666770) (автор [@MiraMusic_AI](https://x.com/MiraMusic_AI))
...
### Пример 4: [Прощание с пианино на крыше после апокалипсиса](https://x.com/liyue_ai/status/2040062803076341872) (автор [@liyue_ai](https://x.com/liyue_ai))
...
### Пример 5: [Кинематографический 8-мм объектив «рыбий глаз», гоночный FPV-дрон и сверхплавное движение](https://x.com/itsPixieVerse/status/2040030453298811099) (автор [@itsPixieVerse](https://x.com/itsPixieVerse))
...
### Пример 7: [Трассировка лучей, рендер Unreal Engine и городок под ливнем](https://x.com/Gwsubsa/status/2040193631341174792) (автор [@Gwsubsa](https://x.com/Gwsubsa))
...
### Пример 8: [Ночная смена в лунном магазине](https://x.com/zasuko_michiksa/status/2039650311212872036) (автор [@zasuko_michiksa](https://x.com/zasuko_michiksa))
...
### Пример 9: [Пробуждение на крыше и превращение в F-14](https://x.com/john87445528/status/2039496153641660508) (автор [@john87445528](https://x.com/john87445528))
...
### Пример 10: [Сборка брони и уличная контратака](https://x.com/egeberkina/status/2044809303878693242) (автор [@egeberkina](https://x.com/egeberkina))
...
### Пример 11: [Персонаж с изображения 1 в реалистичном игровом стиле](https://x.com/Adam38363368936/status/2039646077230698743) (автор [@Adam38363368936](https://x.com/Adam38363368936))
...
### Пример 13: [Бесшовное превращение по семи изображениям](https://x.com/YaReYaRu30Life/status/2039474680235741681) (автор [@YaReYaRu30Life](https://x.com/YaReYaRu30Life))
...
### Пример 14: [Реклама кроссовок Stridex](https://x.com/ShamsAmin56/status/2045084636695650511) (автор [@ShamsAmin56](https://x.com/ShamsAmin56))
...
### Пример 15: [Промпт по изображению с поющим котом](https://x.com/pan_soramame_da/status/2040921171059752988) (автор [@pan_soramame_da](https://x.com/pan_soramame_da))
...
### Пример 16: [Аниме-промпт с референсом персонажа](https://x.com/Reiria123/status/2041118339393826933) (автор [@Reiria123](https://x.com/Reiria123))
...
### Пример 18: [Фиксированная иерархия референсов раскадровки](https://x.com/startracker/status/2075645228271497462) (автор [@startracker](https://x.com/startracker))
...
### Пример 19: [Монтаж поглощения энергии VOLTIA](https://x.com/itsPixieVerse/status/2077526641207881830) (автор [@itsPixieVerse](https://x.com/itsPixieVerse))
...
### Пример 20: [Дворцовое признание Клеопатры](https://x.com/kinovi_ai/status/2077432255157604598) (автор [@kinovi_ai](https://x.com/kinovi_ai))
...
### Пример 21: [Дождливое воссоединение под фонарём](https://x.com/umesh_ai/status/2077419339264016619) (автор [@umesh_ai](https://x.com/umesh_ai))
...
### Пример 23: [Взлёт дракона на горной вершине](https://x.com/minuitIA/status/2080029449169584395) (автор [@minuitIA](https://x.com/minuitIA))
...
### Пример 1: [Бой на катанах в невесомости](https://x.com/MiraMusic_AI/status/2040584525781364874) (автор [@MiraMusic_AI](https://x.com/MiraMusic_AI))
...
### Пример 5: [Слияние в дождливом подземном переулке](https://x.com/Dheepanratnam/status/2039796932562838010) (автор [@Dheepanratnam](https://x.com/Dheepanratnam))
...
### Пример 7: [Глаз внезапно открывается](https://x.com/roco_kn_roco/status/2039323186127630710) (автор [@roco_kn_roco](https://x.com/roco_kn_roco))
...
### Пример 8: [Они сталкиваются в воздухе над парящей лавовой рекой](https://x.com/LudovicCreator/status/2039258991809773666) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 9: [Прогулка креативного директора между измерениями](https://x.com/lukasersil/status/2045070342553493833) (автор [@lukasersil](https://x.com/lukasersil))
...
### Пример 10: [Надпись на алтаре сущности из бездны — тёмное фэнтези](https://x.com/Adam38363368936/status/2041050710721339521) (автор [@Adam38363368936](https://x.com/Adam38363368936))
...
### Пример 11: [Преображение сцены с парящим цветовым кругом интерфейса](https://x.com/johnAGI168/status/2041001869435158629) (автор [@johnAGI168](https://x.com/johnAGI168))
...
### Пример 13: [Превращение в песчаного титана в пустыне](https://x.com/LudovicCreator/status/2076970003404865992) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 14: [Машина для побега, ставшая мусоровозом](https://x.com/LavrionX/status/2077500080932671639) (автор [@LavrionX](https://x.com/LavrionX))
...
### Пример 1: [Катастрофическое затопление суперавианосца](https://x.com/johnAGI168/status/2040432247094870343) (автор [@johnAGI168](https://x.com/johnAGI168))
...
### Пример 2: [Восстановление осколков памяти](https://x.com/TechTalkNAVI/status/2040327899606306840) (автор [@TechTalkNAVI](https://x.com/TechTalkNAVI))
...
### Пример 3: [От чертежа к реальности — превращение одноэтажного дома](https://x.com/craftian_keskin/status/2039053365666037902) (автор [@craftian_keskin](https://x.com/craftian_keskin))
...
### Пример 4: [Портной высокой моды и боевых искусств](https://x.com/Adam38363368936/status/2037359552849666514) (автор [@Adam38363368936](https://x.com/Adam38363368936))
...
### Пример 7: [Тень звёздного света / силуэт из звёздной пыли](https://x.com/TechTalkNAVI/status/2039904725639037110) (автор [@TechTalkNAVI](https://x.com/TechTalkNAVI))
...
### Пример 15: [Стилизованное трёхмерное превращение в барбершопе](https://x.com/ShamiWeb3/status/2039372124079669655) (автор [@ShamiWeb3](https://x.com/ShamiWeb3))
...
### Пример 17: [Женщина-воин — структурированный промпт объекта](https://x.com/noman23761/status/2041406971484815564) (автор [@noman23761](https://x.com/noman23761))
...
### Пример 18: [Лофт-интерьер из коробки](https://x.com/samaote/status/2077757783966183428) (автор [@samaote](https://x.com/samaote))
...
### Пример 22: [Chibi и штормовой взрыв окна](https://x.com/kinovi_ai/status/2079997296000033072) (автор [@kinovi_ai](https://x.com/kinovi_ai))
...
### Пример 23: [Влог из зала после тренировки](https://x.com/doctorwasif/status/2080278207518126084) (автор [@doctorwasif](https://x.com/doctorwasif))
...
### Пример 36: [DV-кадры катастрофы в Помпеях](https://x.com/venturetwins/status/2077080446341656956) (автор [@venturetwins](https://x.com/venturetwins))
...
### Пример 37: [Прогулка астронавта по заброшенному парку аттракционов](https://x.com/LudovicCreator/status/2077694836845465993) (автор [@LudovicCreator](https://x.com/LudovicCreator))
...
### Пример 40: [MiniDV-казус у тыквенной лавки](https://x.com/ou_zhen599/status/2079994995504025794) (автор [@ou_zhen599](https://x.com/ou_zhen599))
...
Для запуска используйте связанную поверхность API/skill; этот репозиторий остается каталогом промптов.

- [Открыть примеры API Seedance 2.0](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service)
- [Установить skill Seedance 2.0](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service)
- [Открыть документацию API EvoLink](https://docs.evolink.ai?utm_source=github&utm_medium=docs&utm_campaign=awesome-seedance-2.0-prompts&utm_content=docs_link)

<a id="contributing"></a>
## 🤝 Участие

Перед предложением промпта прочитайте [CONTRIBUTING.md](CONTRIBUTING.md).

<a id="license"></a>
## ⚖️ Лицензия

Код обслуживания и документация доступны по [Apache License 2.0](LICENSE). Права на исходные промпты и медиа остаются у их авторов.

<a id="copyright-notice"></a>
## ©️ Уведомление об авторских правах

Репозиторий собирает публичные промпты Seedance 2.0 для обучения, исследований и справочных рабочих процессов.

<a id="acknowledge"></a>
## 🙏 Благодарности

Спасибо авторам, публично поделившимся экспериментами Seedance 2.0.
