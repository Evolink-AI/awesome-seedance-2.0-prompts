...
> [!NOTE]
> Блоки промптов остаются идентичными во всех языках. Заголовки из источников могут сохранять оригинальную формулировку, чтобы не размывать границы промпта.
