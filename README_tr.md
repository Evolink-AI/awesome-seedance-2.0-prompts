...
- API dokumani: [`EvoLinkAI/Seedance-2.5-Gateway-Service`](https://github.com/EvoLinkAI/Seedance-2.5-Gateway-Service)
...
- Tam rehber: [`EvoLinkAI/awesome-seedance-2.5-guide`](https://github.com/EvoLinkAI/awesome-seedance-2.5-guide)
...
| Metric | Value |
| --- | --- |
| Toplam prompt sayısı | 163 |
| Kaynak diller | 4 |
| En son kaynak tarihi | `17 Nis 2026` |
