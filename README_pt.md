...
> [!NOTE]
> Os blocos de prompt permanecem idênticos em todos os idiomas. Títulos derivados da fonte podem manter a redação original para preservar o limite do prompt.
